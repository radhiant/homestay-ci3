<div class="row">
    ...
    <div class="col-lg-12">
        <div class="d-flex justify-content-between">
            <h1 class="h4 mb-4 text-gray-800 font-weight-bold"> <span class="badge badge-primary btn-circle"><i class="fas fa-chart-line"></i></span>  Sales
            </h1>
        </div>
    ...
    <div class="col-lg-12">
        <div class="card mb-5">
            ...
            <div class="card-header bg-primary d-flex justify-content-between">
                ...
                <div>
                    <a href="#" class="btn btn-success rounded-pill btn-sm shadow" data-target="#tsalesModal" data-toggle="modal">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <form action="<?= base_url() ?>sales/mhapus" method="POST" enctype="multipart/form-data"
