...
<div class="row">
    ...
    <div class="col-lg-12 mb-3">
        <div class="d-flex">
            <div>
                <a href="<?= base_url() ?>sales" class="btn btn-primary rounded-circle mr-1"><i
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h5 class="mr-4">Nama Sales</h5>
                    <h4 class="font-weight-bold"><?= $d->sales_nama ?></h4>
                </div>
                <hr class="sidebar-divider d-none d-md-block">

                <div class="d-flex justify-content-between">
                    <h5 class="mr-4">No. Telepon</h5>
                    <h4 class="font-weight-bold"><?= $d->sales_notelp ?></h4>
                </div>
                <hr class="sidebar-divider d-none d-md-block">

                <div class="d-flex justify-content-between">
                    <h5 class="mr-4">Tanggal Bayar</h5>
                    <h4 class="font-weight-bold">
                        <?= tglIndo($d->sales_tgl_bayar) ?>
                    </h4>
                </div>
                <hr class="sidebar-divider d-none d-md-block">

                <div class="d-flex justify-content-between">
                    <h5 class="mr-4">Biaya Sales</h5>
                    <h4 class="font-weight-bold">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <h4 class="font-weight-bold"><?= $d->sales_ket ?></h4>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <h6 class="font-weight-bold"><?= tglIndo($d->sales_tgl_input) ?></h6>
                </div>
