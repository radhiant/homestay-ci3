<form action="<?= base_url() ?>deposit/proses_tambah" name="myForm" method="POST" enctype="multipart/form-data"
            ...
            <div class="card mb-5">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="kamarid" value="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datetimepicker" name="tgl" id="tgl" autocomplete="off">
                    </div>
