...
function konfirmasi(id) {
    ...
    swal.fire({
        ...
        if (result.value) {
            loadingklik();
            window.location.href = base_url + "deposit/proses_hapus/" + id;
        }
    });
...
function hapusAll() {
    ...
    swal.fire({
        ...
        if (result.value) {
            loadingklik();
            window.location.href = base_url + "deposit/hapus_all";
        }
    });
...
function kembalikan(id, nominal) {
    $('#iddeposit').val(id);
...
$(document).ready(function() {
    ...
    table = $('#table-1').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('deposit/getDataDeposit')?>",
            "type": "POST"
        },
