<!-- Modal Tambah-->
<div class="modal fade" id="tkatbiayaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?= base_url() ?>katbiaya/proses_tambah" name="myForm" method="POST" enctype="multipart/form-data"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>ID Kategori Biaya</label>
                        <input type="text" class="form-control" name="idkatbiaya" value="<?= $kode ?>" readonly>
                    </div>
...
<!-- Modal Ubah-->
<div class="modal fade" id="ukatbiayaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?= base_url() ?>katbiaya/proses_ubah" name="myFormUpdate" method="POST"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>ID Kategori Biaya</label>
                        <input type="text" class="form-control" name="idkatbiaya" id="idkatbiaya" readonly>
                    </div>
