...
function getVendor(id) {
    ...
    var base_url = link + 'Vendor/getData';
    ...
    $.ajax({
        ...
        success: function(hasil) {
            $('#idvendor').val(hasil[0].vendor_id);
            $('#namaV').val(hasil[0].vendor_nama);
            $('#kontak').val(hasil[0].vendor_kontak);
            $('#notelp').val(hasil[0].vendor_notelp);
            $('#alamat').val(hasil[0].vendor_alamat);
            $('#ket').val(hasil[0].vendor_ket);
            enable();
        }
    });
}
...
$(document).ready(function() {
    ...
    table = $('#table-1').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('Vendor/getDataVendor')?>",
            "type": "POST"
        },
