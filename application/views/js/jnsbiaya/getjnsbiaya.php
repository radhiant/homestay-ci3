...
function konfirmasi(id) {
    ...
    swal.fire({
        ...
        if (result.value) {
            loadingklik();
            window.location.href = base_url + "Jnsbiaya/proses_hapus/" + id;
        }
    });
...
function hapusAll() {
    ...
    swal.fire({
        ...
        if (result.value) {
            loadingklik();
            window.location.href = base_url + "Jnsbiaya/hapus_all";
        }
    });
...
function getjnsbiaya(id) {
    disable();
    var link = $('#baseurl').val();
    var base_url = link + 'Jnsbiaya/getData';
    ...
    $.ajax({
        ...
        success: function(hasil) {
            $('#idjnsbiaya').val(hasil[0].jnsbiaya_id);
            $('#namaK').val(hasil[0].jnsbiaya_nama);
            $('#ket').val(hasil[0].jnsbiaya_ket);
            enable();
        }
    });
}
...
$(document).ready(function() {
    ...
    table = $('#table-1').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('Jnsbiaya/getDatajnsbiaya')?>",
            "type": "POST"
        },
