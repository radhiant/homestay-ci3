...
<form action="<?= base_url() ?>pelanggan/proses_ubah" name="myForm" method="POST" enctype="multipart/form-data"
    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" class="form-control" name="idP" value="<?= $d->pelanggan_id ?>">

                    <div class="form-group">
                        <label>No KTP</label>
                        <input type="text" class="form-control" name="noktp" value="<?= $d->pelanggan_noktp ?>">
                    </div>

                    <div class="form-group">
                        <label>Nama Lengkap</label>
                        <input type="text" class="form-control" name="namaL" value="<?= $d->pelanggan_nama ?>">
                    </div>
                    ...
                    <div class="form-group">
                        <label>No Telp</label>
                        <input type="text" class="form-control" name="notelp" value="<?= $d->pelanggan_notelp ?>">
                    </div>

                    <div class="form-group">
                        <label>Pekerjaan</label>
                        <input type="text" class="form-control" name="pekerjaan" value="<?= $d->pelanggan_pekerjaan ?>">
                    </div>

                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea name="alamat" class="form-control"><?= $d->pelanggan_alamat ?></textarea>
                    </div>

                    <input id="mydata" type="hidden" class="form-control" name="mydata" value="" />
                    <input type="hidden" name="mydatalama" value="<?= $d->pelanggan_foto ?>">
        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="hidden" name="flama" value="<?= $d->pelanggan_foto ?>">
