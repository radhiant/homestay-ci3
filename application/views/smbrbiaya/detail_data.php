...
<div class="row justify-content-center">
    ...
    <div class="col-lg-12 mb-3">
        <div class="d-flex">
            <div>
                <a href="<?= base_url() ?>smbrbiaya" class="btn btn-primary rounded-circle mr-1"><i
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h5 class="mr-4">ID Sumber Biaya</h5>
                    <h4 class="font-weight-bold"><?= $d->smbrbiaya_id ?></h4>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <h4 class="font-weight-bold"><?= $d->smbrbiaya_ket ?></h4>
                </div>
